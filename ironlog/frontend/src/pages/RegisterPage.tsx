...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen min-h-dvh flex flex-col bg-slate-50">
      {/* Hero */}
      <div className="bg-gradient-to-br from-emerald-500 to-teal-600 pt-14 pb-10 px-6 flex flex-col items-center">
        ...
        <p className="text-emerald-100 text-sm mt-1">开始你的力量之旅</p>
      </div>

      {/* Form card */}
      <div className="flex-1 px-6 -mt-5">
        <div className="bg-white rounded-3xl shadow-lg p-6 space-y-5">
          <h2 className="text-xl font-bold text-slate-900">创建账号</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-1.5">
              <label className="block text-sm font-medium text-slate-700">昵称 <span className="text-slate-400 font-normal">（可选）</span></label>
              <input
                type="text"
                value={nickname}
