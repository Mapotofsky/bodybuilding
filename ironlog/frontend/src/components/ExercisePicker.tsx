...
export default function ExercisePicker({
  ...
  const picker = (
    <div className={presentation === "sheet" ? "bg-white w-full max-w-[480px] rounded-t-3xl max-h-[80vh] flex flex-col" : "flex-1 min-h-0 flex flex-col"}>
